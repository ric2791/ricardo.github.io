...
type Algorithm = AsymmetricAlgorithm | SymmetricAlgorithm;
type JwtHeader = {
    kid: string;
};
 ...
 * @api public
 */
export declare const decodeAsymmetric: (token: string, key: string, signedAlgorithm: Algorithm, noVerify?: boolean) => any;
 ...
 * @api public
 */
export declare const decodeSymmetric: (token: string, key: string, signedAlgorithm: Algorithm, noVerify?: boolean) => any;
/**
 ...
 * @api public
 */
export declare const encodeSymmetric: (payload: object, key: string, algorithm?: SymmetricAlgorithm) => string;
/**
 * Encodes JWT object to string.
 * The encoding algorithm must be RS256
 *
 ...
 * @returns
 */
export declare const encodeAsymmetric: (payload: object, key: string, algorithm: AsymmetricAlgorithm, header?: JwtHeader) => string;
